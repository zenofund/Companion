...
interface CompanionProfileFormProps {
  profile: any;
  onSuccess?: () => void;
  onSave: (data: CompanionProfileFormData) => Promise<void>;
  isLoading?: boolean;
}

export function CompanionProfileForm({ profile, onSuccess, onSave, isLoading = false }: CompanionProfileFormProps) {
            ...
            <div>
              ...
              <div className="space-y-3 mt-2">
                <div className="flex gap-2">
                  ...
                  />
                  <label htmlFor="gallery-upload-form" className="flex-1">
                    <Button
                      type="button"
                      variant="outline"
